...
Model.load(model_name, min_diff=0.01, learning_rate=0.0002, cycles=100, ignore_minimum=1, activation_values=[4,4,4,100], hidden_shaped=False, normaliser_depth=0)

...
countries = ["ZAF", "CAN", "USA", "NLD", "ESP", "FRA"]
...
for i in filer:
    ...
    if line[0] in countries and len(line[0]) > 0:
        ...
        country_stringency_index[line[0]].append(Decimal(line[45]))
        country_population_density[line[0]].append(Decimal(line[47]))
        country_median_age[line[0]].append(Decimal(line[48]))
        country_life_expectancy[line[0]].append(Decimal(line[59]))
        country_develop_index[line[0]].append(Decimal(line[60])*Decimal(100))
    ...
    for i in range(len(new_cases_per_mill)-input_size-output_size):
        if i <= half_point:
            for j in range(input_size):
                ...
                to_write_test += str(value1) + "," + str(value2) + "," + str(value8) + ","
        ...
        for j in range(input_size):
            ...
            value12 = life_expectancy[i+j]
            value13 = develop_index[i+j]
            to_write_train += str(value1) + "," + str(value2) + "," + str(value8) + ","
